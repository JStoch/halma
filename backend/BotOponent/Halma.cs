...
namespace BotHalma
{
    internal class Halma : IDisposable
    {
        ...
        public static Dictionary<char, int> Alphabet = InitializeAlphabet();
        ...
        public class PawnCoord : Interfaces.IValidatable
        {
            ...
            public static bool IsValid(IValidatable? obj)
            {
                ...
                return pawnCoord != null && pawnCoord.X >= 0 && pawnCoord.X < Halma.BOARD_SIZE && pawnCoord.Y >= 0 && pawnCoord.Y < Halma.BOARD_SIZE;
            }
        ...
        public class Move : Interfaces.IValidatable
        {
            ...
            public static Move ReturnInvalidMove()
            {
                return new Move(new PawnCoord(-1, -1), new PawnCoord(-1, -1));
            }
            ...
            public void FromTupleQuadruple(int fromX, int fromY, int toX, int toY)
            {
                this.From = new PawnCoord(fromX, fromY);
                this.To = new PawnCoord(toX, toY);
            }
        }
